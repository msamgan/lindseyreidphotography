...
import Slider from "@/Components/Homne/Slide.jsx";
        ...
        <>
            ...
            <div className={''}>
                <div className={'max-w-7xl mx-auto text-center'}>
                    <h1 className={'text-5xl mb-4 dancing-script-heading mt-8'}>
                        {appName}
                    </h1>
                </div>

                <header className="bg-white text-gray-800 mt-8 mb-8">
                    <div className="container flex justify-between h-16 mx-auto md:justify-center md:space-x-8">
                                ...
                                menu().map((menuItem, index) => {
                                    return (
                                        <li className="flex cursor-pointer hover:text-grey-900" key={index}>
                                            <Link rel="noopener noreferrer" href={menuItem.link}
                                                  className="flex items-center px-4 -mb-1 border-b-2 border-transparent">{menuItem.label}
                                            </Link>
                                        </li>
                                    )
                                })
                        ...
                        <button title="Button" type="button" className="p-4 md:hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor" className="w-6 h-6 text-gray-800">
                    ...
                    <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        <div className="flex flex-col">
                            <p className="text-black mb-2 text-2xl">
                                ...
                                and the friendship, are all an important part of your day. </p>

                            <p className="text-black mb-2 text-2xl"> I look forward to talking to
                                you about how to best preserve them. I also welcome inquires about engagement, family
                                portraits, individual portraiture, and destination weddings. For any additional
                                questions, please message me through the "send message" link under the contact
                                information tab. I can't wait to capture your next big day.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-12">
                            <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                                <a rel="noopener noreferrer" href="#"
                                   className="flex justify-center space-x-3 md:justify-start px-12 text-lg">
                            ...
                            <div className="col-span-12 text-center md:text-left md:col-span-3 mb-2">
                                <p className="pb-1 text-lg font-medium">Contact Information</p>
                                <ul>
                                    <li>
                                        <a rel="noopener noreferrer" href="#"
                                           className="hover:text-orange-600">photographybylbr@gmail.com</a>
                                    </li>
                                    <li>
                            ...
                            <div className="col-span-12 text-center md:text-left md:col-span-3">
                                <p className="pb-1 text-lg font-medium">Client Access</p>
                                <div className={'flex flex-row'}>
                                    <input
                                        className={'w-full rounded-md focus:ring focus:ri focus:ri border-gray-300 text-gray-900'}/>
                                    <button type="button"
                                            className="px-4 py-2 ml-2 border rounded-md border-gray-800">Go
                                    </button>
                                </div>
                            </div>
                        </div>
