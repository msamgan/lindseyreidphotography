            ...
            setActionHtml(
                <div>
                    <div className="has-tooltip">
                        <span className="tooltip rounded shadow-lg p-1 bg-gray-100 text-black -mt-8">Edit Gallery</span>
                        <Link
...
const DeleteGallery = ({ gallery, getGalleries }) => {
    ...
    useEffect(() => {
        if (gallery.uuid !== getPortfolioUuId()) {
            setActionHtml(<div className="has-tooltip">
                <span className="tooltip rounded shadow-lg p-1 bg-gray-100 text-black -mt-8">Delete Gallery</span>
                <div
                    onClick={() => {
                        Swal.fire({
                            title: "Are you sure?",
