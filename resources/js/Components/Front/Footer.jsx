        ...
        <footer className="py-6 bg-gray-100 text-gray-900">
            <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                <div className="grid grid-cols-12">
                        ...
                        <ul className={"mt-2"}>
                            <li>
                                <a
                                    ...
                                    href="#"
                                    className="hover:text-orange-600 text-xl pt-2"
                                >
                    ...
                    {/*<div className="col-span-12 text-center md:text-left md:col-span-3">
                        ...
                        <div className={"flex flex-row"}>
                            <input
                                className={
                                    "w-full rounded-md focus:ring focus:ri focus:ri border-gray-300 text-gray-900"
                                }
                            />
                            <button type="button" className="px-4 py-2 ml-2 border rounded-md border-gray-800">
                                Go
                            </button>
                        </div>
                    </div>*/}
                ...
                <div className="grid justify-center pt-6 lg:justify-between">
                    <div className="flex flex-col self-center text-2xl text-center md:block lg:col-start-1 md:space-x-6 sunydale">
                        ...
                        <Link rel="noopener noreferrer" href={route("login")}>
