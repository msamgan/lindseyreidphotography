            ...
            <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                <div className="flex flex-col">
                    ...
                    <p className="text-black mb-2 text-2xl">
                        ...
                        weddings. For any additional questions, please message me through the "send message"
                        link under the contact information tab. I can't wait to capture your next big day.
                    </p>
                </div>
            </div>
        </div>
